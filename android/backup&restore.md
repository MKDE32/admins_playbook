...
Important:
    ...
    You can back up to 15 GB of storage at no charge for your Google account. You can also get access to more storage with a Google One account afterwards.
You can set up your device to automatically back up your files.
    Open your device's Settings app.
    Tap Google services and then All services.
    Tip: Select the data you want to back up: Photos & videos, Device data, or both.
...
To disable your backup:
    Tap Settings and then Google and then All services.
